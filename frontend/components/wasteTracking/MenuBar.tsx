  ...
  return (
    <>
      ...
      <div className="fixed bottom-0 left-0 h-20 w-full bg-green-100 z-50 shadow-[0_-5px_20px_rgba(0,0,0,0.05)]">
        <div className="flex justify-between content-center items-center align-middle px-6 pb-6 pt-8 h-20">
          {menuItems.map((item) => {
            ...
            return (
              ...
              >
                ...
                <span
                  className={`text-xs font-bold ${isActive ? "text-green-700" : "text-gray-500"}`}
                >
                  {item.label}
                </span>
