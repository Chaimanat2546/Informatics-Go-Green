...
export class StatisticsController {
    ...
    async getStats(
        ...
        const wasteStats = await this.statisticsService.getWasteCategoryDistribution(type, date);
    ...
    async getSixMonthsCategories(
        @Query('userId') userId?: string,
    ) {
        return await this.statisticsService.getWasteWeightByCategorySixMonths(userId);
    }
}